...
class FileShare(db.Model):
    ...
    share_id = db.Column(db.String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    file_id = db.Column(db.String(36), db.ForeignKey('files.file_id', ondelete='CASCADE'), nullable=False)
    shared_with = db.Column(db.String(36), db.ForeignKey('user_login.id', ondelete='CASCADE'), nullable=False)
